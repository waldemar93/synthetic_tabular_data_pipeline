...
class Trainer:
    def __init__(self, diffusion, train_iter, lr, weight_decay, steps, device=torch.device('cuda:1'), print_every=500):
    ...
    def run_loop(self):
        ...
        while step < self.steps:
            ...
            # pull X and the (possibly empty) y tensor
            x, y_batch = next(self.train_iter)
            if y_batch.numel() > 0:
                out_dict = {'y': y_batch}
            else:
                out_dict = {}
